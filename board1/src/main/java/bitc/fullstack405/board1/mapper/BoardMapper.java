...
// @Mapper : mybatis의 Mapper로써 데이터베이스와 연동됨을 스프링 프레임워크에 알려주는 애너테이션
// mybatis에서 제공하는 SQL 쿼리문 xml 파일과 1:1로 연동되어 있음
@Mapper
public interface BoardMapper {
    // Mapper 파일에 등록된 메서드명과 데이터 타입을 xml 파일에서 그대로 사용함
    // 전체 목록
    ...
    // @Param : mybatis의 xml에서 사용할 변수명을 지정하는 애너테이션, @Param을 사용하지 않을 경우 매개변수의 이름을 그대로 사용함
