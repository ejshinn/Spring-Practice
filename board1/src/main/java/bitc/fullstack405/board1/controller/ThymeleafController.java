...
public class ThymeleafController {
    ...
    public ModelAndView study01() {
        ...
        // view 파일로 데이터 전달하기
        // addObject(이름, 데이터) : ModelAndView 클래스 타입의 객체에 데이터를 추가하는 메서드
    ...
    public ModelAndView study02() {
        ...
        member.setMemberName("신짱구");
        member.setMemberId("shin");
        member.setMemberAge(5);
        member.setMemberEmail("shin@bitc.ac.kr");

        // 데이터 추가
        mv.addObject("member", member);

        // 문자열 데이터 추가
        mv.addObject("str1", "첫 번째");
        mv.addObject("str2", "두 번째");
        // null 값을 추가
        ...
        // 배열 데이터 생성
        String[] strArray = {"첫 번째", "두 번째", "세 번째", "네 번째", "다섯 번째"};
        // list 타입의 데이터 생성
        ...
        // MemberDTO 클래스 타입의 객체를 memberList라는 이름으로 저장
