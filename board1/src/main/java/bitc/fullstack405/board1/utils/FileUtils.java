...
// @Component, @Bean은 스프링 프레임워크에서 객체를 생성하여 사용하고 관리하는 라이브러리를 뜻하는 애너테이션
// @Bean : 스프링 프레임워크 혹은 각종 서드파티 회사에서 제공하는 라이브러리의 클래스를 사용 시 사용하는 애너테이션
// @Component : 사용자가 직접 작성한 클래스를 스프링 프레임워크에 관리를 맡기기 위해서 사용하는 애너테이션
@Component
