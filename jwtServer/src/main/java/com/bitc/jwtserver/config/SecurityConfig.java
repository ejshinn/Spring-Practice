...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // cors 허용할 메서드 (GET, POST, PUT, DELETE)
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
            ...
            // 회원가입, login을 위한 /auth/** url과 게시물 목록을 위한 /board url은 인증없이 사용 가능
            ...
            //  addFilterBefore() : 첫 번째 매개변수로 지정한 필터를 두 번째 매개변수로 지정한 스프링 시큐리티 필터보다 먼저 동작
            // addFilterAfter() : 첫 번째 매개변수로 지정한 필터를 두 번째 매개변수로 지정한 스프링 시큐리티 필터 다음에 동작
